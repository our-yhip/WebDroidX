package com.app.webdroidx.adapters;
...
//    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            Glide.with(context)
                    .load(sharedPref.getBaseUrl() + "/upload/" + obj.image.replace(" ", "%20"))
                    .thumbnail(0.1f)
            ...
            vItem.cardView.setOnClickListener(view -> {
                if (mOnItemClickListener != null) {
                    ...
                    ((MainActivity) context).loadWebPage(obj.name, obj.type, obj.url, obj.url_dark, obj.content, obj.target);
            ...
            if (adsPref.getIsNativeDrawerMenu()) {
                ...
                if (adsPref.getAdStatus()) {
                    vItem.loadNativeAd(context,
                            ...
                            adsPref.getApplovinMaxNativeManualUnitId(),
                            adsPref.getApplovinDiscoveryMrecZoneId(),
                            adsPref.getWortiseNativeUnitId(),
