...
import com.app.webdroidx.adapters.AdapterNavigation;
...
import com.app.webdroidx.fragments.FragmentWebView;
...
public class MainActivity extends AppCompatActivity implements LoadUrlListener, DrawerStateListener, DefaultLifecycleObserver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadWebPage();
        new Handler(Looper.getMainLooper()).postDelayed(this::notificationOpenHandler, 500);
    ...
    private void loadWebPage() {
        loadWebPage(items.get(0).name, items.get(0).type, items.get(0).url, items.get(0).url_dark, items.get(0).content, items.get(0).target);
        loadNavigationMenu();
    ...
    public void loadWebPage(String name, String type, String urlLight, String urlDark, String content, String target) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_privacy:
                ...
                intent.putExtra("link", sharedPref.getPrivacyPolicy());
                startActivity(intent);
                return true;
